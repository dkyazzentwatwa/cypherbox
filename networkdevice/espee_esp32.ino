...
void displayTitleScreen() {
  ...
  u8g2_for_adafruit_gfx.setCursor(10, 32);                 // Centered vertically
...
void displayInfoScreen() {
  ...
  u8g2_for_adafruit_gfx.setCursor(15, 18);
  ...
  u8g2_for_adafruit_gfx.setCursor(15, 38);
  u8g2_for_adafruit_gfx.print("network scanning game.");

  u8g2_for_adafruit_gfx.setCursor(15, 48);
  u8g2_for_adafruit_gfx.print("Feed ESPEE by");

  u8g2_for_adafruit_gfx.setCursor(15, 58);
  u8g2_for_adafruit_gfx.print("scanning WiFi!");
