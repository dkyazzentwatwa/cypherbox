...
void setup() {
  ...
  u8g2_for_adafruit_gfx.print("Available commands:");
  u8g2_for_adafruit_gfx.setCursor(0, 8);
  u8g2_for_adafruit_gfx.print("WIFI \"ssid for spaced named\"");
  u8g2_for_adafruit_gfx.setCursor(0, 16);
  u8g2_for_adafruit_gfx.print("PASS password");
  u8g2_for_adafruit_gfx.setCursor(0, 24);
  u8g2_for_adafruit_gfx.print("START_WIFI");
  u8g2_for_adafruit_gfx.setCursor(0, 32);
  u8g2_for_adafruit_gfx.print("STOP_WIFI");
  u8g2_for_adafruit_gfx.setCursor(0, 40);
  u8g2_for_adafruit_gfx.print("SCAN_WIFI");
  u8g2_for_adafruit_gfx.setCursor(0, 48);
  u8g2_for_adafruit_gfx.print("BT_SCAN");
  u8g2_for_adafruit_gfx.setCursor(0, 56);
  u8g2_for_adafruit_gfx.print("STOP_BT");
  display.display();
